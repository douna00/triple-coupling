...
df_x.to_csv(r'E:\dualmode_expect_XP_12\nega\x1x2_expect_0.6_-1j_0.8_x.csv', index=False)

# 保存 p1p2
df_p = pd.DataFrame({'Time': t, 'p1p2_expect': np.real(result.expect[1])})
df_p.to_csv(r'E:\dualmode_expect_XP_12\nega\p1p2_expect_0.6_-1j_0.8_p.csv', index=False)
